...
class Enemigo(Personaje):
    ...
    def alcanzo_Personaje(self, Personaje):
        return self.rect.colliderect(Personaje.rect)

    def update(self, slave, Personaje):
        self.muerte()
        if self.esta_vivo and not self.alcanzo_Personaje(Personaje):
            ahora = pygame.time.get_ticks()
