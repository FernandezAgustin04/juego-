...
class NivelDos(Nivel):
    def __init__(self, pantalla) -> None:
        ...
        #PLATAFORMA 
        piso = plataforma(self.pantalla,r"img\piso_hielo.png", (WIDTH,82),0,HEIGHT-82)

        plataforma_a = plataforma(self.pantalla,r"img\plat_hielo.png", (400,50),0,260)
        plataforma_b = plataforma(self.pantalla,r"img\plat_hielo.png", (700,50),260,430)
        plataforma_c = plataforma(self.pantalla,r"img\plat_hielo.png", (700,50),1040,540)
        plataforma_d = plataforma(self.pantalla,r"img\plat_hielo.png", (260,50),480,315)
        plataforma_e = plataforma(self.pantalla,r"img\plat_hielo.png", (200,50),780,245)
        plataforma_f = plataforma(self.pantalla,r"img\plat_hielo.png", (200,50),1000,200)
        ...
        enemigo_1_movimientos = [quieto_01, correr_01]
        
        enemigo = Enemigo(pantalla, quieto_00[0],(60,90),530,380,enemigo_00_movimientos,900,260)
        # enemigo_01 = Enemigo(self.pantalla, quieto_01[0], (60, 90),400,200, enemigo_1_movimientos, 900, 400)     
        enemigo_01 = Enemigo(pantalla, quieto_01[0], (60,90),780,260, enemigo_1_movimientos, 600, 360)
        ...
        super().__init__(pantalla, personaje_principal, lista_plataformas, img_fondo, enemigo,enemigo_01, pala, vidas)